...
library(data.table)
library(ggplot2)
# Functions (data generation and analytical calculations) ---- 
...
ggplot(weights[, .(weight_var = var(Weight)),
  ...
  ylab("variance of weight parameters") +
  theme(legend.title = element_text(size = 18),
        ...
        legend.box = "vertical") 
ggsave('plots/pdf/weightvar_comp.pdf', device = "pdf", width = 10, height = 5, units = "in", scale = 1, dpi = 30)
ggsave('plots/png/weightvar_comp.png', device = "png", width = 10, height = 5, units = "in", scale = 1, dpi = 30)
